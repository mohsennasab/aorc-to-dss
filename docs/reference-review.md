...
The script works from an existing event catalog. AORCtoDSS instead starts from
a GeoLibre area and reads AORC directly.
...
AORCtoDSS uses the official wrapper through a dedicated adapter. The adapter
